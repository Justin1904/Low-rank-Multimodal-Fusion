...
class LMF(nn.Module):
    '''
    Implements the Low-rank Multimodal Fusion model for multimodal sentiment analysis, speaker trait analysis, emotion recognition, as is described in:
    Zhun, Liu, et al. "Efficient Low-rank Multimodal Fusion with Modality Specific Factors.", ACL 2018 Oral.
    '''
