...
def main(options):
    ...
    model_path = os.path.join(model_path, "model_{}_{}.pt".format(signiture, emotion))
        ...
        with open(output_path, "w+") as out:
            ...
            writer.writerow(
                [
                    ...
                    "batch_size",
                    "weight_decay",
                    "Best Validation CrossEntropyLoss",
    ...
    for i in range(total_settings):
        ...
        for e in range(epochs):
            ...
            for batch in train_iterator:
                ...
                y = Variable(
                    batch[-1].view(-1, output_dim).float().type(LONG),
                    requires_grad=False,
                )
                try:
...
if __name__ == "__main__":
    ...
    OPTIONS.add_argument(
        "--data_path", dest="data_path", type=str, default="directory/to/data/"
    )
